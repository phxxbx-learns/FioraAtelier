                            ...
                            <tr>
                                ...
                                <td>
                                    <form method="POST" class="stock-update-form">
                                        ...
                                        <input type="number" name="current_stock" value="<?php echo $product['current_stock']; ?>" class="stock-input" min="0" required>
                                        <button type="submit" name="update_stock" class="btn-primary stock-update-btn">Update</button>
                                    </form>
                                </td>
                            </tr>
                        <?php endforeach; ?>
