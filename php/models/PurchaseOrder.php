    ...
    public function create() {
        ...
        try {
            if($stmt->execute()) {
                ...
                // Log the error - ADD THIS FOR DEBUGGING
                $errorInfo = $stmt->errorInfo();
                error_log("PurchaseOrder create failed - SQLSTATE: " . $errorInfo[0] . ", Error: " . $errorInfo[2]);
                error_log("Query: " . $query);
                error_log("Values - supplier_id: " . $this->supplier_id . ", order_date: " . $this->order_date . 
                         ", expected_date: " . $this->expected_date . ", status: " . $this->status . 
                         ", total_amount: " . $this->total_amount);
                return false;
            }
        } catch (PDOException $e) {
            error_log("PurchaseOrder PDOException: " . $e->getMessage());
            error_log("Query: " . $query);
            return false;
        }
    }
